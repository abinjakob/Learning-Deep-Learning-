...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 30 15:43:13 2023

Basic Python Coding from Deep Learning Tutorial by Mike Cohen 
Section 07 - Artificial Neural Networks

-> Here the code from the file S07_MultiLayerAnn is modified to remove the 
   non-linear activation function from the model design
